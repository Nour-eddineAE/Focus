...
public class JWTAuthorisationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(request.getServletPath().equals(JWTUtil.REFRESH_TOKEN_ENDPOINT)
            ...
            /*
            * If the path equals /api/refreshToken", no need to continue,
            * since the token that was sent has no "roles" attribute
            */
            ...
            if(authorizationToken != null && authorizationToken.startsWith(JWTUtil.HEADER_PREFIX)) {
                ...
                try {
                    ...
                    DecodedJWT decodedJWT = JWTUtil
                            .getDecodedJWT(authorizationToken, algorithm);
